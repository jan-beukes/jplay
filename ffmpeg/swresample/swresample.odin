...
foreign swresample {
    ...
    build_matrix2 :: proc(in_layout: ^types.Channel_Layout, out_layout: ^types.Channel_Layout, center_mix_level: f64, surround_mix_level: f64, lfe_mix_level: f64, rematrix_maxval: f64, rematrix_volume: f64, swr_matrix: ^f64, stride: i32, matrix_encoding: types.Matrix_Encoding, log_ctx: rawptr) -> i32 ---
